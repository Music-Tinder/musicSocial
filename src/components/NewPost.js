  ...
  this.setState({subject:"",message:""})
    ...
    render(){
        ...
        return (
            <div>
                <form>
                <label> subject </label> <input onChange={this.subjectHandler} value={this.state.subject} />
                <br/>
                <label> message </label> <input onChange={this.messageHandler}  value={this.state.message}  />
                <br/> 
